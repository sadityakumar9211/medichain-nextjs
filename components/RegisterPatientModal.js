...
export default function RegisterPatientModal({ isVisible, onClose, account }) {
    ...
    const downloadPrivateKey = async () => {
        ...
        const file = await new Blob([privateKey || "Failed to Generate Private Key... Please cancel the Patient Registration..."], {
            type: "text/plain",
        })
    ...
    const downloadPublicKey = async () => {
        ...
        const element = document.createElement("a")
        const file = await new Blob([publicKey || "Failed to Generate Public Key... Please cancel the Patient Registration..."], {
            type: "text/plain",
        })
        element.href = URL.createObjectURL(file)
                    ...
                    <div>
                        <div className="alert alert-success shadow-lg mb-4">
                            <div>
                                ...
                                <span>
                                    Save Your{" "}
                                    <div className="tooltip" data-tip="Do not Edit this File after Download">
                                    <span
